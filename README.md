...
description: "This repo contains code for a web application, which can read decibels and occupancy data from IoT Hub and show the real-time data on a web page."
---

# web-apps-node-iot-hub-data-visualization

This repo contains code for a web application, which can read decibels and occupancy data from IoT Hub and show the real-time data in a line chart on the web page.
...
- For quickest results, simulate decibels data using the [Raspberry Pi Azure IoT Online Simulator](https://azure-samples.github.io/raspberry-pi-web-simulator/#Getstarted). Paste in the **device connection string**, and select the **Run** button.

- If you have a physical Raspberry Pi and BME280 sensor, you may measure and report real decibels and occupancy values by following the [Connect Raspberry Pi to Azure IoT Hub (Node.js)](https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-raspberry-pi-kit-node-get-started) tutorial.
